    ...
    return (
        ...
        <footer className="py-12 bg-gray-50 xl:pt-8 dark:bg-gray-800">
            <div className="mx-auto w-full max-w-screen-2xl px-4">
                <div className="grid gap-12 xl:grid-cols-3 xl:gap-24">
                    <div className="mb-6 md:mb-0 col-span-2">
                        <a href={`/${lang}`} className="flex items-center space-x-3">
                            ...
                            <span className="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">Ask Pic</span>
                        </a>
                        <div className="flex mt-6 mb-6">
                            {/* <a href="mailto:kevin@roleplex.com" className="text-gray-500 hover:text-gray-900 dark:hover:text-white">
                        ...
                        <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2024 <a href={`/${lang}`} className="hover:underline">Ask Pic™</a>. All Rights Reserved.
                        </span>
                    ...
                    <div>
                        ...
                        <ul className="text-gray-500 dark:text-gray-400 font-medium">
                            ...
                            <li className='mb-4'>
                                <a href="mailto:kevin@roleplex.com" className="hover:underline" title='Send an email to Ask Pic: Free online describe image, Text Extraction & Code Conversion'>Email</a>
                            </li>
                            {/* <li>
